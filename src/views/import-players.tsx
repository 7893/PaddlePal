      ...
      <div class="max-w-2xl mx-auto">
        ...
        <Card title="输入选手名单" class="mb-6">
          ...
          <textarea
            id="names"
            rows={10}
            class="w-full border border-slate-200 rounded-xl px-4 py-3 font-mono text-sm focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
            placeholder="张三&#10;李四&#10;王五"
          ></textarea>
        ...
        <Card title="CSV 导入">
          ...
          <button
            onclick="importCSV()"
            class="mt-4 px-6 py-2.5 bg-blue-500 text-white rounded-xl font-medium hover:bg-blue-600 transition-colors"
          >
            导入 CSV
          </button>
        </Card>
