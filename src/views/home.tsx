      ...
      <div class="relative bg-gradient-to-br from-slate-900 via-emerald-900 to-slate-900 overflow-hidden">
          ...
          <div class="max-w-7xl mx-auto px-6">
            <div class="flex items-center justify-between h-16">
              ...
              <div class="hidden md:flex items-center gap-1">
                <a
                  href="/live"
                  class="px-4 py-2 text-sm text-white/80 hover:text-white hover:bg-white/10 rounded-lg transition-colors"
                >
                  实时比分
                </a>
                <a
                ...
                <a
                  href="/admin"
                  class="admin-only px-4 py-2 text-sm text-emerald-400 hover:text-emerald-300 hover:bg-white/10 rounded-lg transition-colors"
                  style="display:none"
                >
                  管理后台
                </a>
              ...
              <div class="flex items-center gap-3">
                <div id="user-info" class="hidden items-center gap-3">
                  ...
                  <a href="/logout" class="text-sm text-white/50 hover:text-red-400 transition-colors">
                    退出
                  </a>
                </div>
                <a
                  href="/login"
                  id="login-btn"
                  class="px-5 py-2 bg-white/10 hover:bg-white/20 text-white text-sm rounded-lg backdrop-blur-sm border border-white/20 transition-all"
                >
                  登录
                </a>
              </div>
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-6 py-20 md:py-28">
          ...
          <div class="flex flex-wrap gap-4">
            <a
              href="/live"
              class="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-400 hover:to-teal-400 text-white font-medium rounded-xl shadow-lg shadow-emerald-500/30 transition-all"
            >
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
                  stroke-linecap="round"
            ...
            <a
              href="/schedule"
              class="inline-flex items-center gap-2 px-8 py-4 bg-white/10 hover:bg-white/20 text-white font-medium rounded-xl border border-white/20 backdrop-blur-sm transition-all"
            >
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
                  stroke-linecap="round"
          ...
          <div class="flex items-end justify-between mb-10">
            <div>
              ...
              <p class="text-slate-500">
                共 {events.length} 个项目，{events.filter((e) => e.finish === e.plays && e.plays > 0).length} 个已完赛
              </p>
            </div>
            <a
              href="/events"
            ...
            {events.map((ev) => (
              <div class="bg-white rounded-2xl p-6 shadow-sm hover:shadow-lg transition-shadow border border-slate-100">
                ...
                <div class="flex gap-3">
                  <a
                    href={`/results/${ev.key}`}
                    class="flex-1 text-center py-2 text-sm text-emerald-600 hover:bg-emerald-50 rounded-lg transition-colors font-medium"
                  >
                    成绩
                  </a>
                  <a
                    href={`/standings/${ev.key}`}
                    class="flex-1 text-center py-2 text-sm text-slate-600 hover:bg-slate-50 rounded-lg transition-colors"
                  >
                    积分榜
                  </a>
                  <a
        ...
        <div class="max-w-7xl mx-auto px-6">
          <div class="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div class="flex gap-6 text-sm">
              ...
              <a href="/qr" class="hover:text-white transition-colors">
                扫码入口
              </a>
            </div>
          </div>
