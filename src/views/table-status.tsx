    ...
    <Layout title="球台状态">
      ...
      <PageWrapper>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
          {tables.map(t => (
            <div class={`rounded-2xl p-5 border-2 transition-all ${
              t.status === 'playing' ? 'border-red-400 bg-gradient-to-br from-red-50 to-rose-50 shadow-lg' :
              t.status === 'ready' ? 'border-amber-400 bg-gradient-to-br from-amber-50 to-orange-50' :
              ...
              <div class="flex items-center justify-between mb-3">
                ...
                <span class={`px-3 py-1 rounded-full text-xs font-medium ${
                  ...
                  t.status === 'ready' ? 'bg-amber-500 text-white' :
              ...
              {t.match ? (
                <div>
                  ...
                  <div class="flex items-center justify-between">
                    ...
                    <span class="font-bold text-lg mx-3 text-slate-800">{t.match.score1}:{t.match.score2}</span>
