...
type PlayerStat = { id: number; name: string; team: string; played: number; wins: number; losses: number };
type TeamStat = { name: string; players: number; total_played: number; total_wins: number };
          ...
          <table class="w-full text-sm">
            <thead>
              <tr class="border-b border-slate-200 text-left text-slate-500">
                ...
                <th class="py-3 font-semibold w-32">胜率</th>
              </tr>
            </thead>
