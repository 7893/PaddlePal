(function() {
    var k = {
            getItem: function(a) { return a && this.hasItem(a) ? unescape(document.cookie.replace(RegExp("(?:^|.*;\\s*)" + escape(a).replace(/[\-\.\+\*]/g, "\\$&") + "\\s*\\=\\s*((?:[^;](?!;))*[^;]?).*"), "$1")) : null },
            setItem: function(a, c, d, f, h, e) {
                if (a && !/^(?:expires|max\-age|path|domain|secure)$/i.test(a)) {
                    var g = "";
                    if (d) switch (d.constructor) {
                            case Number:
                                g = Infinity === d ? "; expires=Tue, 19 Jan 2038 03:14:07 GMT" : "; max-age=" + d; break;
                            case String:
                                g = "; expires=" + d; break;
                            case Date:
                                g = "; expires=" + d.toGMTString() } document.cookie =
        ...
        a = {
            ...
            init: function(b) {
                ...
                a.widgets.each(function(a) { var b = $(this);
                    setTimeout(function() { b.removeClass("unloaded");
                        setTimeout(function() { b.removeClass("animation") }, 300) }, 100 * a) })
            },
            Events: {
                onWindowResize: function(b) { a.window_width = $(window).width();
                    a.window_height = $(window).height() },
                onHashChange: function(b) {
                    var c = window.location.hash,
                        d = c.replace(/[#!\/]/g,
                            ""),
                        f = function() { var b = $('div.widget[data-name="' + d + '"]');
                            b.length && a.openWidget(b) };
                    a.widget_open ? "" === c ? a.closeWidget(b) : a.widget_open.data("name") !== d && f() : "" !== c && f()
                },
                onMouseDown: function(b) { a.widget_open || (a.dragging_x = b.clientX) },
                onMouseUp: function(b) {
                    if (!a.widget_open && a.dragging_x) {
                        $(document).scrollLeft(0);
                        a.dragging_x = 0;
                        b = -1 * (a.scroll_container_width - a.window_width);
                        var c = function() { setTimeout(function() { a.widget_scroll_container.css("transition", "") }, 400) };
                ...
                onMouseMove: function(b) { if (!a.widget_open && a.dragging_x) { var c = a.left + b.clientX - a.dragging_x;
                ...
                sidebarClick: function(b) { switch ($(b.target).attr("class")) {
                        case "cancel":
                            a.closeWidget(b); break;
                        case "refresh":
                            a.refreshWidget(b); break;
                        case "download":
                            window.open("http://codecanyon.net/user/MelonHTML5", "_blank"); break;
                        case "back":
                            a.previousWidget(b); break;
                        case "next":
                            a.nextWidget(b) } }
            },
            ...
            closeWidget: function(b) { window.location.hash = "";
                document.title = a.title_prefix + "Metro Framework";
                a.widget_scroll_container.show();
                a.widget_preview.removeClass("open");
                a.widget_open = !1;
                setTimeout(function() { $("#widget_preview_content").remove() }, 300) },
            refreshWidget: function() { a._loadWidget(a.widget_open, !1) },
            ...
            nextWidget: function(b) { var c = a.widget_open.next();
                c.length || (c = a.widget_open.parent().children("div.widget").first()); var d = c.data("url");
            ...
            _loadWidget: function(b, c) {
                var d = b.data("name"),
                    f = function(b) {
                        ...
                        "true" !== k.getItem("melonhtml5_metro_ui_sidebar_first_time") && (a.widget_sidebar.addClass("open"), a.widget_sidebar.mouseenter(function() { k.setItem("melonhtml5_metro_ui_sidebar_first_time", "true", Infinity);
                ...
                var g = function() {
                    ...
                    l = function(b) { var c = (new Date).getTime() - h;
                        1300 < c ? (a.widget_preview.children("div.dot").remove(), "undefined" !== typeof b && b()) : setTimeout(function() { a.widget_preview.children("div.dot").remove(); "undefined" !== typeof b && b() }, 1300 - c) };
                a.widget_preview.width();
                g();
                "undefined" === typeof c && (c = !0);
                c && void 0 !== a.widget_page_data[d] ? l(function() { f(a.widget_page_data[d]) }) : (e = $.trim(b.data("url")), 0 < e.length && $.ajax({
                    url: e,
                    cache: !1,
                    type: "POST",
                    data: {},
                    ...
                    success: function(b, c, e) { l(function() { a.widget_page_data[d] = b;
                            f(b) }) }
                }))
            }
        };
